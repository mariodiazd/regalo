...
@Component({
  selector: 'app-pregunta-cinco',
  templateUrl: './pregunta-cinco.component.html',
  styleUrls: ['./pregunta-cinco.component.css']
})


export class PreguntaCincoComponent implements OnInit {
  ...
  siguientePregunta(){
    this.router.navigateByUrl('pregunta-6/'+this.puntos);
  }
